package com.itis2019.markrecorder.ui.adapters
...
import com.itis2019.markrecorder.utils.ITEM_VIEW_TYPE_FOLDER
import com.itis2019.markrecorder.utils.ITEM_VIEW_TYPE_HEADER
import com.itis2019.markrecorder.utils.ITEM_VIEW_TYPE_ITEM
    ...
    override fun onBindViewHolder(holder: RecordDataViewHolder, position: Int) =
        when (holder) {
            ...
            is RecordDataViewHolder.RecordHolder -> {
                ...
                holder.bind(item.record, item.isWhite)
...
sealed class RecordDataItem {
    ...
    data class RecordItem(val record: Record, val isWhite: Boolean = false) : RecordDataItem() {
