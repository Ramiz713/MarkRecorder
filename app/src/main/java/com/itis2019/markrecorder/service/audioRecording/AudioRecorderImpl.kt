package com.itis2019.markrecorder.service.audioRecording

import android.media.AudioFormat
import android.media.AudioRecord
import android.media.MediaRecorder
import android.os.Environment
import com.itis2019.markrecorder.utils.updateWavHeader
import com.itis2019.markrecorder.utils.writeWavHeader
...
class AudioRecorderImpl : AudioRecorder {
    ...
    private fun createNewFile() {
        ...
        val folder = File("$storeLocation/MarkRecorder")
        if (!folder.exists())
            folder.mkdir()
        ...
        val filePath = "$storeLocation/MarkRecorder/$fileName"
        file = File(filePath)
