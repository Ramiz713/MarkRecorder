...
import com.itis2019.markrecorder.service.audioRecording.AudioRecordService
...
import com.itis2019.markrecorder.utils.getTimeInFormatWithSeconds
...
class RecordingFragment : BaseFragment() {
    ...
    private fun observeNavigateToRecordConfig() =
        viewModel.navigateToRecordConfig.observe(viewLifecycleOwner, Observer {
            ...
            unbindService()
            val action =
                RecordingFragmentDirections.actionRecordingFragmentToLectureConfigFragment(record)
    ...
    private fun enableButtons() {
        btn_stop.makeViewVisibleAndEnabled()
        btn_mark.makeViewVisibleAndEnabled()
    }

    private fun disableButtons() {
        btn_stop.makeViewTransparentAndDisabled()
